...
export default function PostitPreview({ text, results, nickname, baseFontClassName, label }: Props) {
  return (
    <div
    ...
    >
      {label && (
        <p className="text-[10px] font-medium uppercase tracking-wider mb-2" style={{ color: INK_DIM }}>
          {label}
        </p>
      )}
      <div className="leading-relaxed break-keep">
        <SentenceRenderer
          ...
          glyphSize={30}
          ink={INK}
          baseFontClassName={baseFontClassName}
        />
      </div>
