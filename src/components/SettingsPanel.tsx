...
export default function SettingsPanel({ nickname, visibility, userId, lang }: Props) {
  ...
  const VIS_HINT: Record<Visibility, string> =
    lang === "ko"
      ? { PRIVATE: "나만 볼 수 있어", LINK_ONLY: "링크를 아는 사람만 볼 수 있어", PARTIAL: "비슷한 취향에서 발견될 수 있어" }
      : lang === "ja"
      ? { PRIVATE: "自分だけが見られます", LINK_ONLY: "リンクを知っている人だけが見られます", PARTIAL: "似た好みの人から発見される可能性があります" }
  ...
  const t = {
    settings:    lang === "ko" ? "설정"       : lang === "ja" ? "設定"          : "Settings",
    nickname:    lang === "ko" ? "닉네임"     : lang === "ja" ? "ニックネーム"   : "Nickname",
    nickMax:     lang === "ko" ? "최대 20자"  : lang === "ja" ? "最大20文字"     : "Max 20 characters",
    visibility:  lang === "ko" ? "공개 범위"  : lang === "ja" ? "公開設定"       : "Visibility",
    copyLink:    lang === "ko" ? "공유 링크 복사 _" : lang === "ja" ? "共有リンクをコピー _" : "Copy Share Link _",
    linkCopied:  lang === "ko" ? "링크 복사됨 ✓"    : lang === "ja" ? "リンクをコピーしました ✓" : "Link Copied ✓",
    save:        lang === "ko" ? "[[ 저장 ]]" : lang === "ja" ? "[[ 保存 ]]"     : "[[ Save ]]",
    signOut:     lang === "ko" ? "로그아웃 _" : lang === "ja" ? "ログアウト _"   : "Sign Out _",
  };
        ...
        <div className="fixed inset-0 z-50 flex items-end justify-center"
          ...
          <div className="w-full max-w-sm p-6 space-y-6"
            ...
            <div className="space-y-2">
              ...
              <input ref={inputRef} value={nickValue}
