...
/* ── Cube Unlock 인트로 ──────────────────────────────────────
   QR 스캔(?src=qr) 진입 시에만 표시되는 2초 리츄얼 화면.
   Phase 1 (0~0.5s)   큐브 fade-in + scale 0.95→1
   Phase 2 (0.5~1.5s) 엣지 글로우 펄스
   Phase 3 (1.5~2.0s) 앞면이 문처럼 열림
   Phase 4 (2.0s~)    화면 전체가 공간 페이지로 페이드
    ...
    >
      ...
      <style>{`
        ...
        .unlock-cube {
          ...
          animation: unlockDrift 2s ease-in-out both;
        }
        .unlock-face {
          position: absolute;
          inset: 0;
        ...
        .uf-front {
          ...
          animation:
            ...
            unlockDoor 0.5s cubic-bezier(0.45, 0, 0.2, 1) 1.5s forwards;
        }
