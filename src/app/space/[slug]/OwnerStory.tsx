...
export default function OwnerStory({
  ...
  const t = {
    story:    lang === "ko" ? "사장님 이야기" : lang === "ja" ? "オーナーの話" : lang === "zh" ? "老板的故事" : "Owner's Story",
    ...
    noStory:  lang === "ko" ? "아직 사장님의 이야기가 준비되지 않았어요." : lang === "ja" ? "オーナーのストーリーはまだ準備中です。" : lang === "zh" ? "老板的故事还没有准备好。" : "The owner's story isn't ready yet.",
  };
